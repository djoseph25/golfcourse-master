					...
					<Navbar color="white" light expand="md" className="navbar navbar-default">
						...
						<Collapse isOpen={isOpen} navbar>
							...
							<Nav className="mx-auto" navbar>
								<NavLink id="login" className="links" activeClassName="active-link" to="/Login">
									LOGIN
								</NavLink>
							</Nav>
						</Collapse>
				...
				<div className="wrap">
					<Row>
						...
						<Col className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<form className="login-form">
								<label id="login-label">Please Log On</label>
								<br></br>
								<input type="text/" placeholder="Username" className="input-style1" />

								<input type="text" placeholder="PassWord" className="input-style2" />
								<br></br>
								<input type="checkbox" placeholder="remember me" />
								<span class="password-login">
									{' '}
									Remember me <label id="password">Forgot Password</label>
								</span>
								<br></br>
					...
					<footer id="footer-login">
						...
						<div className="footer-login">
							<i>powered by jonas club software</i>
						</div>
					</footer>
				</div>
			</div>
