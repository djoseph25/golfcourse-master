										...
										<div class="contact-container">
											<Row>
												...
												<Col className="col-lg-6 col-md-6 col-sm-12">
													...
													<div id="contact-email">
														<a href="">sales@isleworth.com</a>
													</div>
												</Col>
											</Row>
											<div id="vertical-line-2"></div>
											<div id="inquiry">MAKE AN INQUIRY</div>
											<div id="vertical-line"></div>
										</div>
										<p id="learn-more-p">
											To learn more about Isleworth or to contact our club community, please complete the
											inquiry form below.
										</p>
										<p id="learn-more-p-2">
											...
											to visit our employment website.
										</p>
										{/* Form Contact Page */}
										<div id="contact-form">
											<form id="contactpage-form">
												...
												<header>Reason for Inquiry</header>
												<select class="form-group col-1">
													<option>Golf</option>
